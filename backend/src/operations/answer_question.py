from src.db.query import get_question_by_user_id_and_question_SK, get_vacancy_by_user_id_and_vacancy_SK
from src.ai import check_answer

from src.db.utils import TABLE, USER_ID, extract_vacancy_sk, update_entity
...
def answer_question(table, payload):
    ...
    vacancy_SK = extract_vacancy_sk(question_SK)
    if not vacancy_SK:
